...
<%-- Created by IntelliJ IDEA. User: LENOVO Date: 24-Nov-23 Time: 9:34 AM To change this template use File | Settings |
    File Templates. --%>
...
<div id="wrapper">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-nav">
            <li>
                <a class="mb-3" href="<%=request.getContextPath()%>/xemcautruc"><i
                        class="fa fa-building-o"></i>Cấu trúc công ty</a>
            </li>
            <li class="active">
            ...
            <li>
                <a class="mb-3" href="<%=request.getContextPath()%>/views/truongphong/GuiEmail.jsp"><i
            ...
            <li>
                <a class="mb-3" href="<%=request.getContextPath()%>/listSalary"><i
    ...
    <section id="content-wrapper">
        <div class="row p-3">
            <div class="col-lg-12">
                <p class="page-header text-center">Thông tin trưởng phòng</p>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
