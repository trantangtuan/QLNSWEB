...
<div id="wrapper">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-nav">
            ...
            <li>
                <a class="mt-3" href="<%=request.getContextPath()%>/views/truongphong/GuiEmail.jsp"
                    ...
                    <div>
                        ...
                        <div class="d-flex justify-content-around align-items-around">
                            <select class="form-select w-25 ms-3" name="tenCN" id="tenCN">
                                <option selected><%= (String) request.getAttribute("tenChiNhanh") %></option>
                            </select>
                            <select class="form-select w-25 ms-3" name="tenPB" id="tenPB">
                                <option selected><%= (String) request.getAttribute("tenPhongBan") %></option>
                            </select>

                            <select class="form-select w-25 ms-3" name="tenCV" id="tenCV">
                                <option selected>Chọn chức vụ</option>
                                <c:forEach var="listTitle" items="${tenChucVu}">
                                    <option value="${listTitle.tenChucVu}"><c:out value="${listTitle.tenChucVu}" /></option>
                                </c:forEach>
                            </select>
                        </div>
                        <div
