<%-- Created by IntelliJ IDEA. User: GIGABYTE Date: 11/22/2023 Time: 8:18 PM To change this template use File | Settings
    | File Templates. --%>
            ...
            <div id="wrapper">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-nav">
                        <li class="active">
                            <a class="mb-3" href="<%=request.getContextPath()%>/xemcautruc"><i class="fa fa-building-o"></i>Cấu trúc công
                                ty</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="mb-3" href="<%=request.getContextPath()%>/views/nhanvien/NhanVienGuiMail.jsp"><i class="fa fa-commenting-o"></i>Gửi mail</a>
                        </li>
                    </ul>
                </aside>
